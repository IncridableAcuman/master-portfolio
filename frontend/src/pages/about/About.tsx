    ...
    <div>
      ...
      <div className={`w-full min-h-screen pt-24 ${theme ==="light" ? "bg-color" : "bg-gray-900 text-white"}`}>
        <div className="pdg flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8 lg:gap-10">
          <img src="./myphoto.jpg" alt="my photo" className="w-full md:w-64 rounded-md" />
          <div className="w-full">
            <p className="text-center">I am a backend developer with a strong interest in software engineering. 
